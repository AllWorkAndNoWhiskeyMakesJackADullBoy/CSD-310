...
insert_new_student = db.students.insert_one(new_student_document)
...
print(f"Student ID: {new_student[
'student_id'
]
}")
print(f"First Name: {new_student[
'first_name'
]
}")
print(f"Last Name: {new_student[
'last_name'
]
}\n")
